    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_LABA7OOP, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LABA7OOP));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LABA7OOP));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_LABA7OOP);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        pF[0] = new MyRombik(200, 1, 10, 0, RGB(255, 0, 0), hWnd, 3);
        ...
        pF[1] = new MyOtrezok(150, 2, 1, 1, RGB(0, 255, 255), hWnd);
        ...
        pF[2] = new MyPoluKrug(100, 3, 4, 1, RGB(0, 0, 255), hWnd);
        for (int i = 0; i < 3; i++)
        {
            Data[i].pFig = pF[i];
